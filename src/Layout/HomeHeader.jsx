...
const Header = () => {
  ...
  return (
    <div className="home-header-height-100"> 
        ...
        <div className="row home-header-row w-100">
          ...
          <div className="home-header-left-logo-div">
            ...
            <div className="col-12 col-md-6">
              <div className="d-flex header-middle-logo-div justify-content-center align-items-center h-100">
                <img className="home-header-middle-logo" src={logoImg}></img>
              </div>
            </div>
            <div className=" col-12 col-md-3">
              <div className="second-cont d-flex align-items-center h-100">
